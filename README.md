...
A mobile-first, modern cryptocurrency trading platform built using **React**, **TypeScript**, and **Tailwind CSS**. This project provides a secure wallet management experience with a sleek UI and native-like mobile experience.
